<template>
  ...
  <h2></h2>
  <h4>Приложение для проверки билетов</h4>

  <var-button @click="goCheck()" size="large" color="#574AE2" type="primary" >Проверка билетов</var-button>
  <br>
  <br>
  <var-button @click="goAbout()" text outline size="large" text-color="#574AE2" >О приложении</var-button>
